...
echo bin\jre\bin\java.exe -Xmx1024m -Djava.net.preferIPv4Stack=true -cp !CLASSPATH! tools.sctrade.companion.CompanionApplication
echo.

REM Run with java.exe (console) instead of javaw.exe to capture errors
bin\jre\bin\java.exe -Xmx1024m -Djava.net.preferIPv4Stack=true -cp !CLASSPATH! tools.sctrade.companion.CompanionApplication
